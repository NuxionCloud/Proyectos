...
const dishSchema = z.object({
  ...
  subcategoria: z.enum(['smash', 'bocata', 'hotdog', 'desayuno', 'tapa', 'bebida']),
  // Precio en euros (carta agosto 2026 — el cliente YA publica precios).
  // Si el plato tiene tamaño media/entera: `precio` = entera y `precioMedia` = media.
  precio: z.number().optional(),
  precioMedia: z.number().optional(),
